...
-->
            ...
            <div class="linked">                
                <article class="link linked row indexPage" id="post-<?php the_ID(); ?>">
                    ...
                    <div class="seven columns omega">
						...
						<p class="social"><?php if (function_exists('simple_url_shortener')) : ?><a href="<?php the_permalink(); ?>" rel="bookmark" class="ss-icon alpha" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php else : ?><a href="<?php the_permalink() ?>" class="ss-icon alpha" rel="bookmark" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php endif; ?><a class="ss-icon ss-social middle" href="mailto:?subject=A%20link%20post%20from%20ianpatrickhines.com&body=<?php the_title_attribute(); ?>%0D%0A%0D%0A<?php the_permalink() ?>" title="Email">email</a><?php if (function_exists('simple_url_shortener')) : ?><a href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=@ianpatrickhines&related=yarrcat" rel="bookmark" class="ss-icon omega" title="Reply" target="_blank">reply</a><?php else : ?><a href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=@ianpatrickhines&related=yarrcat" class="ss-icon omega" rel="bookmark" title="Reply" target="_blank">reply</a><?php endif; ?></p> 
                    </div>
                </article>
            </div> 
            ...
            <article class="article indexPage" id="post-<?php the_ID(); ?>">
				...
				<p class="social"><?php if (function_exists('simple_url_shortener')) : ?><a href="<?php the_permalink(); ?>" rel="bookmark" class="ss-icon alpha" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php else : ?><a href="<?php the_permalink() ?>" class="ss-icon alpha" rel="bookmark" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php endif; ?><a class="ss-icon ss-social middle" href="mailto:?subject=A%20post%20from%20ianpatrickhines.com&body=<?php the_title_attribute(); ?>%0D%0A%0D%0A<?php the_permalink() ?>" title="Email">email</a><?php if (function_exists('simple_url_shortener')) : ?><a href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=@ianpatrickhines&related=yarrcat" rel="bookmark" class="ss-icon omega" title="Reply" target="_blank">reply</a><?php else : ?><a href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=@ianpatrickhines&related=yarrcat" class="ss-icon omega" rel="bookmark" title="Reply" target="_blank">reply</a><?php endif; ?></p> 
...
<?php echo $author; ?><?php } ?></a></h2>
				...
				<p class="social"><?php if (function_exists('simple_url_shortener')) : ?><a href="<?php the_permalink(); ?>" rel="bookmark" class="ss-icon alpha" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php else : ?><a href="<?php the_permalink() ?>" class="ss-icon alpha" rel="bookmark" title="Permanent Link to '<?php the_title_attribute(); ?>'">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><?php endif; ?><a class="ss-icon ss-social middle" href="mailto:?subject=A%20post%20from%20ianpatrickhines.com&body=<?php $quote = get_post_meta($post->ID, 'quote', true); if ($quote == '') { ?><?php } else { ?><?php echo $quote; ?><?php } ?>%0D%0A%0D%0A<?php the_permalink() ?>" title="Email">email</a><?php if (function_exists('simple_url_shortener')) : ?><a href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=@ianpatrickhines&related=yarrcat" rel="bookmark" class="ss-icon omega" title="Reply" target="_blank">reply</a><?php else : ?><a href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=@ianpatrickhines&related=yarrcat" class="ss-icon omega" rel="bookmark" title="Reply" target="_blank">reply</a><?php endif; ?></p> 
            ...
            <article class="article" id="post-<?php the_ID(); ?>">
				...
				<p class="social"><a class="ss-icon alpha" href="<?php the_permalink() ?>" title="Bookmark">bookmark</a><a class="ss-icon ss-social middle" href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=<?php the_title_attribute(); ?>&via=ianpatrickhines&related=yarrcat" title="Tweet" target="_blank">twitter</a><a class="ss-icon ss-social middle" href="mailto:?subject=A%20post%20from%20ianpatrickhines.com&body=<?php the_title_attribute(); ?>%0D%0A%0D%0A<?php the_permalink() ?>" title="Email">email</a><?php if (function_exists('simple_url_shortener')) : ?><a href="http://twitter.com/intent/tweet?url=<?php echo simple_url_shortener('','service=bit.ly+key&apikey=R_a6dc414291bb882024ddd99690f5eb61&login=ianhines&cache=yes'); ?>&text=@ianpatrickhines&related=yarrcat" rel="bookmark" class="ss-icon omega" title="Reply" target="_blank">reply</a><?php else : ?><a href="http://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=@ianpatrickhines&related=yarrcat" class="ss-icon omega" rel="bookmark" title="Reply" target="_blank">reply</a><?php endif; ?></p> 
